...
MAP_BOUNDS["gm_bigcity"] 				  = { Vector(13172, 13171, -11393),     Vector(-13033, -13164, 2448),       Vector(0,0,-11471)      } --fix duplicate
MAP_BOUNDS["gm_bigcity_improved_lite"] 				  = { Vector(13172, 13171, -11393),     Vector(-13033, -13164, 2448),       Vector(0,0,-11471)      } --fix duplicate
MAP_BOUNDS["gm_bigcity_d"] 				  = { Vector(13172, 13171, -11393), 	Vector(-13033, -13164, 2448),       Vector(0,0,-11471)      } --fix duplicate
MAP_BOUNDS["gm_bigcity_improved"] 		  = { Vector(13172, 13171, -11393),     Vector(-13033, -13164, 2448),       Vector(0,0,-11471)      } --fix duplicate
MAP_BOUNDS["gm_bigcity_sunset"] 		  = { Vector(13172, 13171, -11393), 	Vector(-13033, -13164, 2448),       Vector(0,0,-11471)      } --fix duplicate
MAP_BOUNDS["gm_bigcity_winter"] 		  = { Vector(13172, 13171, -11393),     Vector(-13033, -13164, 2448),       Vector(0,0,-11471)      } --fix duplicate
...
MAP_BOUNDS["gm_buttes2"]	  	          = { Vector(16238,16240,-11643),		Vector(-16077,-15983,12053),		Vector(0,0,-14203)		}
...
MAP_BOUNDS["gm_construct"]				  = { Vector(1869, -3696, -555),        Vector(-5247, 6471, 9436),          Vector(0,0,-162)		}
...
MAP_BOUNDS["gm_flatbuild_pb_v02"]      	  = { Vector(15599,15414,485),          Vector(-15208,-15181,15197), 	    Vector(0,0,517)         }
MAP_BOUNDS["gm_flatbuild_pbs_2015_dev"]   = { Vector(15856,15855,-7257),       Vector(-15299,-15695,12088),			Vector(0,0,-7257)       }
MAP_BOUNDS["gm_flatgrass"] 				  = { Vector(15343,15343,-12795),       Vector(-15344,-15344,-12795), 	    Vector(0,0,-12806)		}
...
MAP_BOUNDS["gm_fork"]     				  = { Vector(-15344,15343,-9115),       Vector(15345,-15346,15294),         Vector(0,0,-10443)		} --fix duplicate
...
MAP_BOUNDS["gm_guadalcanal"]			  = { Vector(16236,16236,5606),			Vector(-16240,-16240,-15101),		Vector(0,0,-15242)		}
...
MAP_BOUNDS["phys_town_v2"]      		  = { Vector(-13808,-13806,-10747),     Vector(12816,13825,10044), 	        Vector(0,0,-12748)      }
