...
AddToGDSpawnMenu("Static House 1"             , "gd_building_h1"           , "Buildings", "Building Supplies", false)
AddToGDSpawnMenu("Large Roof Beam"             , "gd_building_h1_p01"       , "Buildings", "Building Supplies", false)
AddToGDSpawnMenu("Single Stabilized Roof Support Beam", "gd_building_h1_p02" , "Buildings", "Building Supplies", false)
AddToGDSpawnMenu("Long Metallic Roof Support Beam", "gd_building_h1_p03" , "Buildings", "Building Supplies", false)
AddToGDSpawnMenu("Short Metallic Roof Support Beam", "gd_building_h1_p04" , "Buildings", "Building Supplies", false)
AddToGDSpawnMenu("Aluminium Roof Tile", "gd_building_h1_p05" , "Buildings", "Building Supplies", false)
AddToGDSpawnMenu("Double Stabilized Roof Support Beam", "gd_building_h1_p06" , "Buildings", "Building Supplies", false)
AddToGDSpawnMenu("Aluminium Upper Door Piece", "gd_building_h1_p07" , "Buildings", "Building Supplies", false)
AddToGDSpawnMenu("Aluminium Wall 01", "gd_building_h1_p08" , "Buildings", "Building Supplies", false)
AddToGDSpawnMenu("Aluminium Wall 02", "gd_building_h1_p09" , "Buildings", "Building Supplies", false)
AddToGDSpawnMenu("Aluminium Wall 03", "gd_building_h1_p10" , "Buildings", "Building Supplies", false)
AddToGDSpawnMenu("Foundation", "gd_building_h1_p11" , "Buildings", "Building Supplies", false)
...
AddToGDSpawnMenu("Sand Storm", "gd_w1_sandstorm" , "Weather", "Tier 1", false)
AddToGDSpawnMenu("Dust Storm", "gd_w1_duststorm" , "Weather", "Tier 1", false)
...
AddToGDSpawnMenu("Iridescent Cloudy WIP", "gd_w1_cldy_irid" , "Weather", "Tier 1", false)
...
AddToGDSpawnMenu("Category 1 Hurricane", "gd_w1_catonehurricane", "Weather", "Tier 1", false)
AddToGDSpawnMenu("Light Breeze", "gd_w1_lightbreeze", "Weather", "Tier 1", false)
...
AddToGDSpawnMenu("Cumulus CLoud WIP", "gd_w1_cumu_cldy" , "Weather", "Tier 1", false)
...
AddToGDSpawnMenu("Category 2 Hurricane", "gd_w2_cattwohurricane", "Weather", "Tier 2", false)
AddToGDSpawnMenu("Beaufort 2 Wind (Light Breeze)", "gd_w2_beaufort2", "Weather", "Tier 2", false)
AddToGDSpawnMenu("Beaufort 3 Wind (Gentle Breeze)", "gd_w2_beaufort3", "Weather", "Tier 2", false)
AddToGDSpawnMenu("Heavy Rain", "gd_w2_heavyrain" , "Weather", "Tier 2", false)
AddToGDSpawnMenu("Mild Breeze", "gd_w2_mildbreeze" , "Weather", "Tier 2", false)
AddToGDSpawnMenu("Shelf Cloud", "gd_w2_shelfcloud" , "Weather", "Tier 2", false)
AddToGDSpawnMenu("Smog", "gd_w2_smog" , "Weather", "Tier 2", false)
AddToGDSpawnMenu("Thunder Storm", "gd_w2_thunderstorm" , "Weather", "Tier 2", false)

--[[
WEATHER TIER 3
--]]

AddToGDSpawnMenu("Strong Breeze" , "gd_w3_strongbreeze" , "Weather", "Tier 3", false)
...
AddToGDSpawnMenu("Blizzard", "gd_w3_blizzard" , "Weather", "Tier 3", false)
AddToGDSpawnMenu("Heat Burst", "gd_w3_heatburst" , "Weather", "Tier 3", false)
AddToGDSpawnMenu("Heavy Ash Storm", "gd_w3_heavyashstorm" , "Weather", "Tier 3", false)
--[[
WEATHER TIER 4
--]]

AddToGDSpawnMenu("Intense Breeze" , "gd_w4_intensebreeze" , "Weather", "Tier 4", false)
AddToGDSpawnMenu("Category 4 Hurricane", "gd_w4_catfourhurricane", "Weather", "Tier 4", false)
AddToGDSpawnMenu("Beaufort 6 Wind (Strong Breeze)", "gd_w4_beaufort6", "Weather", "Tier 4", false)
AddToGDSpawnMenu("Beaufort 7 Wind (High Wind, Moderate Gale, Near Gale)", "gd_w4_beaufort7", "Weather", "Tier 4", false)
AddToGDSpawnMenu("Heavy Acid Rain", "gd_w4_heavyacidrain", "Weather", "Tier 4", false)

--[[
WEATHER TIER 5
--]]

AddToGDSpawnMenu("Very Intense Wind" , "gd_w5_veryintensebreeze" , "Weather", "Tier 5", false)
AddToGDSpawnMenu("Category 5 Hurricane", "gd_w5_catfivehurricane", "Weather", "Tier 5", false)
...
AddToGDSpawnMenu("Dust Devil"     , "gd_d1_dustdevil"       , "Disasters", "Tier 1", false)
...
AddToGDSpawnMenu("Medium Whirlpool" , "gd_d2_whirlpool"			, "Disasters", "Tier 2", false)
AddToGDSpawnMenu("Gustnado"         , "gd_d2_gustnado"			, "Disasters", "Tier 2", false)
AddToGDSpawnMenu("≈2.0 Magnitude Earthquake", "gd_d2_rs2eq"       	, "Disasters", "Tier 2", false)
...
AddToGDSpawnMenu("Silent Hill "           , "gd_d5_silenthill"           , "Disasters", "Tier 5", false)
...
AddToGDSpawnMenu("Black Hole"  , "gd_d10_Black_hole" , "Disasters", "Tier ELE", false)
