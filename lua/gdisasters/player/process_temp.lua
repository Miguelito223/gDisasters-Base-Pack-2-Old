if (CLIENT) then
	...
	function gfx_temperatureEffects()
                ...
                LocalPlayer().gDisasters.HUD.VomitIntensity = math.Clamp(LocalPlayer().gDisasters.HUD.VomitIntensity - RealFrameTime(),0,1)
		...
		if (temp >= 41 or temp <= 32) and math.random(1,300)==1 then
			hud_GDisasters_Hallucinations()
		end
