...
ENT.Data                             = {}
ENT.WedgeSound                       = "disasters/nature/idle.wav"
...
function ENT:OnWedgeEntry(ent) 
	...
	if ent:IsPlayer() or ent:IsNPC() then 
		...
		elseif r >= 150 and r < 200 then 
			...
			ent:EmitSound("disasters/nature/splash_big.mp3", 100, 100, 1)
...
tsunami_water_textures[1]    = Material("nature/floodwater", "nature/floodwater2");
